...
function BlogCard(props) {
    ...
    useEffect(() => {
        ...
        setTimeout(function () {
            setInitStyle("transform transition duration-500 hover:scale-105 overflow-hidden shadow-lg rounded-lg h-90 w-80 cursor-pointer m-auto");
        }, 500);
    }, []);
        ...
        <div class={initStyle}>
            <a href={"https://phrygian-herring-90e.notion.site/File-management-system-Part-1-ffe90d21e13a434eb4412d5e6ff604b2"} target="_blank" class="w-full block h-full">
                <div class="h-40 w-full object-cover">
                    <img alt="blog photo" src={tempPic} class="h-40 w-full object-cover" />
                </div>
